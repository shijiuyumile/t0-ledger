...
function renderSells() {
  ...
  $('#sellSummary').innerHTML = tMode ? `
    ...
    <div class="sum-item"><div class="v ${pnlClass(ap.matchRealized)}">${fmtSign(ap.matchRealized)}</div><div class="k">做T配对净利</div></div>
    <div class="sum-item"><div class="v c-up">${fmtSign(ap.matchRealizedWin)}</div><div class="k">盈利合计</div></div>
    <div class="sum-item"><div class="v c-down">${fmtSign(ap.matchRealizedLoss)}</div><div class="k">亏损合计</div></div>`;
